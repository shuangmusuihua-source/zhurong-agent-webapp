...
export function ChatInput({
  ...
  return (
    <SquircleContainer
      cornerRadius={16}
      className={`flex items-center gap-2 backdrop-blur-xl bg-white/80 dark:bg-chat-bg/70 px-3 py-2 shadow-sm focus-within:ring-2 focus-within:ring-primary/20 transition-all ${className ?? ""}`}
    >
      {leading}
      <textarea
        ref={setRef}
